...
const SITE_TITLE = "UzmaSATRIA - GEOINT Platform";
const SITE_DESCRIPTION = "UzmaSATRIA is a real-time geospatial intelligence platform. Track aircraft, vessels, satellites and CCTV networks on a 3D globe, and monitor earthquakes, wildfires, severe weather, space weather, cyber threats and conflict zones — all from a single interface.";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "UzmaSATRIA - GEOINT Platform",
    description: "Real-time geospatial intelligence. Aircraft, vessels, satellites, CCTV and hazard monitoring on a single 3D globe.",
    type: "website",
    siteName: SITE_NAME,
    locale: "en_US",
    url: SITE_URL,
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "UzmaSATRIA - GEOINT Platform",
        type: "image/png",
      },
    ],
  },
